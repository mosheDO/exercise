...
public class StringUtilTest {
   ...
   @Test
   public void testbackspaceNumberSignInString() {

      assertEquals("ac", StringUtil.backspaceNumberSignInString("abc#d##c"));
      assertEquals("", StringUtil.backspaceNumberSignInString("abc####d##c#"));
      assertEquals("", StringUtil.backspaceNumberSignInString("####d##c#"));
   }
}
